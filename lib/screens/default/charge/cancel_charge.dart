...
class CancelCharge extends StatefulWidget {
  @override
  _CancelChargeState createState() => _CancelChargeState();
}

class _CancelChargeState extends State<CancelCharge> {
  ...
  Widget _appBar() {
    return AppBar(
      elevation: 0,
      title: Text("Cancelar Cobrança"),
      centerTitle: true,
      actions: [
        _buttonInfo("Cancelar Cobrança",
  ...
  void _cancelCharge() {
    ...
    gn.call("cancelCharge", params: params).then((value) {
      setState(() => _loading = false);
      _showMessage("Cobrança Cancelada!", Theme.of(context).accentColor,
