...
class UpdateChargeLink extends StatefulWidget {
  @override
  _UpdateChargeLinkState createState() => _UpdateChargeLinkState();
}

class _UpdateChargeLinkState extends State<UpdateChargeLink> {
        ...
        child: Form(
            ...
            child: Column(
              children: [
                ...
                _form(_formId()),
                _headerForm("Link",
                    "O campo abaixo é referente ao link vinculado a transação.\n"),
                _form(_formExpireAt())
              ],
            )));
  }
  ...
  Widget _formExpireAt() {
    return FormDataField(
      helperText: "Data de vencimento (yyyy-mm-dd)",
  ...
  void _updateChargeLink() {
    ...
    gn.call("updateChargeLink", params: params, body: body).then((value) {
      setState(() => _loading = false);
      _showMessage("Link Atualizado!", Theme.of(context).accentColor,
