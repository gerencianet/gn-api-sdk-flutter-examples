...
class UpdateCharge extends StatefulWidget {
  @override
  _UpdateChargeState createState() => _UpdateChargeState();
}

class _UpdateChargeState extends State<UpdateCharge> {
    ...
    return SingleChildScrollView(
        child: Padding(
            ...
            child: Form(
                key: _formKey,
                child: Column(
                  children: [_form(_formId()), _form(_formExpireAt())],
                ))));
  }
  ...
  Widget _appBar() {
    return AppBar(
      elevation: 0,
      title: Text("Atualizar Transação"),
      centerTitle: true,
      actions: [
        _buttonInfo(
            "Atualizar Transação",
  ...
  void _updateBillet() {
    ...
    gn.call("updateBillet", params: params, body: body).then((value) {
