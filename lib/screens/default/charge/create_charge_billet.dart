...
class CreateChargeBillet extends StatefulWidget {
  @override
  _CreateChargeBilletState createState() => _CreateChargeBilletState();
}

class _CreateChargeBilletState extends State<CreateChargeBillet> {
        ...
        child: Form(
            ...
            child: Column(
              children: [
                ...
                _form(_formPhone()),
                _headerForm("Boleto",
                    "Os campos abaixo faz referência ao boleto a ser criado."),
    ...
    return AppBar(
      ...
      actions: [
        _buttonInfo(
            ...
            "Criar nova transação com pagador atribuido (boleto).\n\n",
            Colors.white)
      ],
    );
  }
