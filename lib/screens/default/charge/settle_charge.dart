...
class SettleCharge extends StatefulWidget {
  @override
  _SettleChargeState createState() => _SettleChargeState();
}

class _SettleChargeState extends State<SettleCharge> {
  ...
  void _settleCharge() {
    ...
    gn.call("settleCharge", params: params).then((value) {
      setState(() => _loading = false);
      _showMessage("Cobrança Marcada Como Pago!", Theme.of(context).accentColor,
