...
class CreateChargeHistory extends StatefulWidget {
  @override
  _CreateChargeHistoryState createState() => _CreateChargeHistoryState();
}

class _CreateChargeHistoryState extends State<CreateChargeHistory> {
            ...
            child: Column(
              children: [
                ...
                _headerForm("Descrição",
                    "O campo abaixo é referente ao texto a ser acrescentado no histórico da transação."),
                _form(_formText()),
              ],
            )));
  }
  ...
  Widget _appBar() {
    return AppBar(
      elevation: 0,
      title: Text("Acrescentar Histórico"),
      centerTitle: true,
      actions: [
        _buttonInfo(
  ...
  void _createChargeHistory() {
    ...
    gn.call("createChargeHistory", params: params, body: body).then((value) {
