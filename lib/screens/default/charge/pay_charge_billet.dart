...
class PayChargeBillet extends StatefulWidget {
  @override
  _PayChargeBilletState createState() => _PayChargeBilletState();
}

class _PayChargeBilletState extends State<PayChargeBillet> {
        ...
        child: Form(
            ...
            child: Column(
              children: [
                ...
                _form(_formId()),
                _headerForm("Cliente",
                    "Os campos abaixo faz referência ao cliente a ser vinculado a transação."),
                _form(_formName()),
                _form(_formCpf()),
                _form(_formPhone()),
                _headerForm("Boleto",
  ...
  Widget _appBar() {
    return AppBar(
      elevation: 0,
      title: Text("Associar Boleto Transação"),
      centerTitle: true,
      actions: [
        _buttonInfo(
            "Associar Boleto Transação",
            "Associa método de pagamento (boleto) à uma transação já criada.\n\n",
            Colors.white)
      ],
    );
  }
