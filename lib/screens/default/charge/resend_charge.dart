...
class ResendCharge extends StatefulWidget {
  @override
  _ResendChargeState createState() => _ResendChargeState();
}

class _ResendChargeState extends State<ResendCharge> {
    ...
    return SingleChildScrollView(
        child: Padding(
            ...
            child: Form(
                key: _formKey,
                child: Column(
                  children: [_form(_formId()), _form(_formEmail())],
                ))));
  }
  ...
  Widget _appBar() {
    return AppBar(
      elevation: 0,
      title: Text("Reenviar Boleto"),
      centerTitle: true,
      actions: [
        _buttonInfo(
            "Reenviar boleto", "Reenvio do boleto bancário para o e-mail desejado.\n\n", Colors.white)
      ],
    );
  }
  ...
  void _resendBillet() {
    ...
    gn.call("resendBillet", params: params, body: body).then((value) {
      setState(() => _loading = false);
      _showMessage("Boleto Reenviado!", Theme.of(context).accentColor,
