...
class CreateCharge extends StatefulWidget {
  @override
  _CreateChargeState createState() => _CreateChargeState();
}

class _CreateChargeState extends State<CreateCharge> {
  ...
  void _createCharge() {
    ...
    gn.call("createCharge", body: body).then((value) {
