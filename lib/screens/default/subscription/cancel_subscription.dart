...
class _CancelSubscriptionState extends State<CancelSubscription> {
  ...
  Widget _appBar() {
    return AppBar(
      ...
      actions: [
        _buttonInfo(
            "Cancelar Assinatura",
            "Cancelar inscrições ativas em um plano de assinaturas.\n\n",
            Colors.white)
      ],
    );
  }
  ...
  void _cancelSubscription() {
    ...
    gn.call("cancelSubscription", params: params).then((value) {
      setState(() => _loading = false);
      _showMessage("Assinatura Cancelada!", Theme.of(context).accentColor,
