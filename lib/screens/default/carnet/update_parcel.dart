...
class UpdateParcel extends StatefulWidget {
  @override
  _UpdateParcelState createState() => _UpdateParcelState();
}

class _UpdateParcelState extends State<UpdateParcel> {
  ...
  Widget _appBar() {
    return AppBar(
      elevation: 0,
      title: Text("Atualizar Parcela"),
      centerTitle: true,
      actions: [
        _buttonInfo(
            "Atualizar Parcela",
            "Alterar data de vencimento de parcela específica de um carnê.\n\n",
            Colors.white)
      ],
    );
  }
  ...
  void _updateParcel() {
    ...
    gn.call("updateParcel", params: params, body: body).then((value) {
      setState(() => _loading = false);
      _showMessage("Parcela Atualizada!", Theme.of(context).accentColor,
