...
class ResendCarnet extends StatefulWidget {
  @override
  _ResendCarnetState createState() => _ResendCarnetState();
}

class _ResendCarnetState extends State<ResendCarnet> {
  ...
  Widget _appBar() {
    return AppBar(
      elevation: 0,
      title: Text("Reenviar Carnê"),
      centerTitle: true,
      actions: [
        _buttonInfo(
            "Reenviar Carnê", "Reenviar carnê por e-mail.\n\n", Colors.white)
      ],
    );
  }
  ...
  void _resendCarnet() {
    ...
    gn.call("resendCarnet", params: params, body: body).then((value) {
      setState(() => _loading = false);
      _showMessage("Carnê Reenviado!", Theme.of(context).accentColor,
