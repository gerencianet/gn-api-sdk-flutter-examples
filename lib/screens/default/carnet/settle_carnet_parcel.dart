...
class SettleParcel extends StatefulWidget {
  @override
  _SettleParcelState createState() => _SettleParcelState();
}

class _SettleParcelState extends State<SettleParcel> {
  ...
  void _settleCarnetParcel() {
    ...
    gn.call("settleCarnetParcel", params: params).then((value) {
      setState(() => _loading = false);
      _showMessage("Parcela Marcada Como Pago!", Theme.of(context).accentColor,
