...
class UpdateCarnetMetadata extends StatefulWidget {
  @override
  _UpdateCarnetMetadataState createState() => _UpdateCarnetMetadataState();
}

class _UpdateCarnetMetadataState extends State<UpdateCarnetMetadata> {
  ...
  Widget _appBar() {
    return AppBar(
      ...
      actions: [
        _buttonInfo(
            "Atualizar Metadata",
            "Incluir informações como 'notification_url' e 'custom_id' em um carnê existente.\n\n",
            Colors.white)
      ],
    );
  }

  void _updateCarnetMetadata() {
    ...
    gn.call("updateCarnetMetadata", params: params, body: body).then((value) {
      setState(() => _loading = false);
      _showMessage("Carnê Atualizado!", Theme.of(context).accentColor,
