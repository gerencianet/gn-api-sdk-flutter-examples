...
class CancelCarnet extends StatefulWidget {
  @override
  _CancelCarnetState createState() => _CancelCarnetState();
}

class _CancelCarnetState extends State<CancelCarnet> {
  ...
  Widget _appBar() {
    return AppBar(
      elevation: 0,
      title: Text("Cancelar Carnê"),
      centerTitle: true,
      actions: [
        _buttonInfo(
            "Cancelar Carnê",
            "Cancela um determinado carnê.\n\n",
            Colors.white)
      ],
    );
  }
  ...
  void _cancelCarnet() {
    ...
    gn.call("cancelCarnet", params: params).then((value) {
      setState(() => _loading = false);
      _showMessage("Carnê Cancelado!", Theme.of(context).accentColor,
