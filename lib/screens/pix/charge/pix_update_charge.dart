...
class PixUpdateCharge extends StatefulWidget {
  @override
  _PixUpdateChargeState createState() => _PixUpdateChargeState();
}

class _PixUpdateChargeState extends State<PixUpdateCharge> {
  ...
  Widget _appBar() {
    return AppBar(
      elevation: 0,
      title: Text("Revisar Cobrança"),
      centerTitle: true,
      actions: [
        _buttonInfo(
            "Revisar Cobrança",
            "PATCH para revisar cobrança PATCH /v2/cob/{txid}\n\n",
            Colors.white)
      ],
    );
  }
  ...
  dynamic _pixUpdateCharge() async {
    ...
    gn.call('pixUpdateCharge', params: params, body: body).then((value) {
      setState(() => _loading = false);
      _showMessage("Cobrança Atualizada!", Theme.of(context).accentColor,
